...
return array(
	...
	# Specify address of the FeedReader instance,
	# used when building absolute URLs, e.g. for PubSubHubbub.
	# Examples:
	# https://example.net/FeedReader/public/
	# https://feedReader.example.net/
	'base_url' => '',

	# Specify address of the FeedReader auto-update server.
	'auto_update_url' => 'https://github.com/bearer1024/feedReaderPHP',

	# Natural language of the user interface, e.g. `en`, `fr`.
	'language' => 'en',

	# Title of this FeedReader instance in the Web user interface.
	'title' => 'FeedReader',
	...
	#	http://example.net/feedReaderPHP/p/i/?c=auth&a=login&u=alice&p=1234
