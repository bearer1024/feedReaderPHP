...
class FreshRSS_entry_Controller extends Minz_ActionController {
	...
	public function readAction() {
		...
		if (FreshRSS_Context::isStateEnabled(FeedReader_Entry::STATE_FAVORITE)) {
			FreshRSS_Context::$state = FeedReader_Entry::STATE_FAVORITE;
		} elseif (FreshRSS_Context::isStateEnabled(FeedReader_Entry::STATE_NOT_FAVORITE)) {
			FreshRSS_Context::$state = FeedReader_Entry::STATE_NOT_FAVORITE;
		} else {
