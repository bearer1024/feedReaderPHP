...
class FreshRSS_Context {
	...
	public static function _get($get) {
		...
		case 's':
			...
			self::$state = self::$state | FeedReader_Entry::STATE_FAVORITE;
			break;
		case 'f':
	...
	public static function isAutoRemoveAvailable() {
		...
		if (self::isStateEnabled(FeedReader_Entry::STATE_READ)) {
			return false;
		}
		if (!self::isStateEnabled(FeedReader_Entry::STATE_NOT_READ)) {
			return false;
		}
		return true;
	}
